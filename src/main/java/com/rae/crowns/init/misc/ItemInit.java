...
public class ItemInit {
    ...
    public static final ItemEntry<Item>
            NATURAL_URANIUM_INGOT   = REGISTRATE.item("natural_uranium_ingot", Item::new).register(),
            ...
            TURBINE_CASING          =
                    REGISTRATE.item("turbine_casing", Item::new)
                            .model((c, p) ->
                                    p.withExistingParent(c.getName(), p.modLoc("block/turbine_stage/casing")))
                            .register();
