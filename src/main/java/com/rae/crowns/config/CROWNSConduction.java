...
public class CROWNSConduction extends ConfigBase {
    ...
    public final ConfigFloat heatExchangerInternal = f(1000000,0,"heatExchangerInternal", Comments.heatExchangerInternal);
    public final ConfigFloat assemblyBlock = f(500000,0,"assemblyBlock", Comments.assemblyBlock);
    @Override
    ...
    private static class Comments {
        ...
        static String heatExchangerInternal ="conduction coefficient between the heat exchanger and the water flowing through it, " +
                "if you have temperature oscillations decrease it";
