...
public class CROWNSNuclear extends ConfigBase {
    public final ConfigBase.ConfigFloat realismCoefficient = f(50000,0,"realismCoef", Comments.realismCoef);
    ...
    public final ConfigBase.ConfigFloat negativeThermalCoef = f(0.02f,0,"negativeThermalCoef", Comments.negativeThermalCoef);
    ...
    private static class Comments {
        ...
        static String negativeThermalCoef ="make neutron less likely to impact when temperature is higher ((temperature - 500) * negativeThermalCoef))";
