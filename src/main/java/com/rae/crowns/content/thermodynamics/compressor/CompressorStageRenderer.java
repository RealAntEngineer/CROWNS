...
public class CompressorStageRenderer extends KineticBlockEntityRenderer<CompressorStageBlockEntity> {
    public CompressorStageRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    @Override
    protected void renderSafe(CompressorStageBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
        ...
        SuperByteBuffer memoryRoll =
                CachedBufferer.partialFacing(PartialModelInit.COMPRESSOR_STAGE, be.getBlockState(), direction.getOpposite());
