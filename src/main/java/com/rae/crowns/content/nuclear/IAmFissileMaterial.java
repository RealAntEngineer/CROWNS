...
public interface IAmFissileMaterial {
    HashMap<ResourceLocation, Couple<Float>> fissileCrossSection = new HashMap<>(
            ...
            ));//for U235,U358 and Plutonium -> percentage of total mass HashMap<ResourceLocation,Float> molarConcentration = new HashMap<>(

    HashMap<ResourceLocation, Float>  molarConcentration = new HashMap<>(Map.of(
