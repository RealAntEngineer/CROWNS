...
public class WaterAsRealGaz {
     ...
     */
    public static SpecificRealGazState isentropicExpansion(SpecificRealGazState fluidState, float expansionFactor){//vapor quality has an issue
        ...
        if (fluidState.vaporQuality() == 1) {
            ...
            if (fluidState.temperature() > TSat(Pf)) {
                ...
                if (dx > 1) {
                    ...
                    return isentropicExpansion(new SpecificRealGazState(TSat(Pf_v), Pf_v, get_h(1, TSat(Pf_v), Pf_v), 1f), Pf_v / Pf);
     ...
     * @return the new fluid state
     */
    public static SpecificRealGazState isentropicExpansion(SpecificRealGazState fluidState, float isentropicYield, float expansionCoef){
     ...
     * @return the new fluid state
     */
    public static SpecificRealGazState isentropicCompression(SpecificRealGazState fluidState, float compressionFactor){
     ...
     * @return the new fluid state
     */
    public static SpecificRealGazState isentropicCompression(SpecificRealGazState fluidState, float yield, float compressionCoef){
